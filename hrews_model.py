...
class HealthRiskPredictor:
    ...
    def create_shap_explainer(self):
        # SHAP explainers were removed to simplify the codebase.
        # If interpretability is required later, add a dedicated implementation.
        print("SHAP explainer is not available in this build.")
        return None
...
def main():
    ...
    # SHAP explainers removed — skip explainer creation.
